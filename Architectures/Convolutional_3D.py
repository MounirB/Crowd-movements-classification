...
def get_model(input_shape, summary=False, num_classes=487, backend='tf'):
...
def get_reduced_model(input_shape, num_classes, summary=False, backend='tf'):
    """ Return the Keras model of the network
    This model fits the description of the C3D model evaluated in the Crowd-11 paper
    """
    model = Sequential()
