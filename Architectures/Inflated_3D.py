...
def Inception_Inflated3d(include_top=True,
    ...
    if weights in WEIGHTS_NAME:
        ...
        # ## HERE WE TRAIN ON MOTION EMOTION DATASET
        ...
        # model.load_weights(weights)
        # # We remove the last layer, this is like model.layers.pop()
        # x = model.layers[-2].output
        # x = Dense(classes, activation='softmax', name='predictions')(x)

        # model = Model(input=inputs, output=x, name='i3d_inception')

    #Just added this on April 12, 2019
    else: #No Weights
